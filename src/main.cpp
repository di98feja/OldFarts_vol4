...
int main()
{
    ...
    Cube cube(400.f, sf::Vector2f(window.getSize().x/2, window.getSize().y*2/3)); // Centered below text
    Sphere sphere(200.f, sf::Vector2f(window.getSize().x/2, window.getSize().y*2/3)); // Centered below text
    sf::Clock clock;
